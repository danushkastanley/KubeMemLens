...
|---|---|---|
| Go | Module baseline 1.25.0; currently built locally with Go 1.26.5 | CI configuration and local build/test |
...
| Current supported | CRI-O | Fedora CoreOS | v2 | Planned |
| Current supported | containerd | GKE Standard Linux node pool | v2 | Planned; no support claim yet |
| Current supported | containerd | EKS managed Linux node group | v2 | Planned; no Fargate support claim |
| Current supported | containerd | AKS Linux node pool | v2 | Planned; no support claim yet |
