...
- Add restricted explanation schema 4 and recommendation schema 2; capture and comparison remain separate work. Verify CLI and PTY workflows with local namespace credentials, including revocation/recovery and terminal restoration.
...
- Verify measured, missing and revoked evidence with a controlled Metrics API on a collector-free local kind cluster. Restricted capture follows separately.
