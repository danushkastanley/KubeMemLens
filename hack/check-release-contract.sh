...
require_text "${workflow}" 'syft-version: v1.49.0'
require_text "${workflow}" 'for platform in linux/amd64 linux/arm64; do'
require_text "${workflow}" 'image-linux-amd64.sbom.json'
